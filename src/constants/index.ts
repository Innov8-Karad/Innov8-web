...
export const UI_STRINGS = {
  ...
  JOBS: {
    ...
    SUBTITLE: 'Post job opportunities and track applicant status',
    ...
    TH_TYPE: 'Type',
    TH_POSTED: 'Posted',
    TH_APPLICANTS: 'Applicants',
    TH_ACTIONS: 'Actions',
    MODAL_TITLE: 'Post New Job',
    EDIT_MODAL_TITLE: 'Edit Job Posting',
    FORM_COMPANY: 'Company Name',
    FORM_ROLE: 'Role / Position',
    FORM_LOCATION: 'Location',
    FORM_SALARY: 'Salary / Package',
    FORM_TYPE: 'Job Type',
    FORM_REQUIREMENTS: 'Requirements (one per line)',
    FORM_BATCHES: 'Eligible Batches (comma separated)',
    FORM_DESCRIPTION: 'Job Description',
    APPLICANTS_TITLE: 'Job Applicants',
    APPLICANTS_SUBTITLE: 'Manage status for',
    TH_STUDENT: 'Student',
    TH_EMAIL: 'Email',
